    ...
    <body>
        ...
        <main class="page_principal"> 
                ...
                <div class="content display-container" style="background-color: rgb(40, 92, 164);justify-content: center; align-items: center; text-align: center;">
                    ...
                    <h3 class="myh3"><% if (session.getAttribute("nom") != null) {%>
            <h3 style="color: black;"> Bienvenue dans votre espace patient Mr/Mme <%= session.getAttribute("nom")%>.</h3> 
                <%} else {%>
                <h3 style="color: black"> Bienvenue dans votre espace patient.</h3>
                <%}%></h3>
